...
function Header() {
  ...
  return (
    <div className="flex justify-evenly p-4 w-full bg-white border-b-2 sticky top-0 left-0 right-0">
      <Link to="/" className="">
        <div className="header_logo w-36 flex items-center">
          <img src="/instagram.png" alt="" className="object-cover" />
          <img src="/arrowdown.png" alt="" className="h-6" />
        </div>
      </Link>
      <div className="input_box w-2/4 h-12 flex justify-around bg-[#e5e5e5] items-center p-2 rounded-lg lg:w-1/5">
      ...
      <div className="header_right flex justify-evenly w-1/5 items-center   ">
        <img src="/home.png" alt="" className="w-8 cursor-pointer" />
        <img src="/message.png" alt="" className="w-8 cursor-pointer" />
        <img
          src="/upload.png"
          alt=""
        ...
        {/* <img src="/discover.png" alt="" className="w-8 cursor-pointer " /> */}

        <span className="w-8 h-8 relative">
          <img src="/hearth.png" alt="" className="w-8 cursor-pointer" />
        ...
        <Menu.Item>
          {({ active }) => (
            <a
              ...
              href="/account-settings"
            >
              <div className="w-full flex border-t border-black-100 items-center h-12 p-2">
